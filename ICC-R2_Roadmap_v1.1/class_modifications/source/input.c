...
int input_read_parameters(struct file_content * pfc,
  ...
  class_call(input_read_parameters_output(pfc,pba,pth,ppt,ptr,ppm,phr,pfo,ple,psd,pop,
             ...
             errmsg,
             errmsg);
  /* ICC-R2 parameter registration */
  class_read_double("mu_icc", ppr->mu_icc);
  class_read_flag("has_icc", ppr->has_icc);
  return _SUCCESS_;
...
int input_read_parameters_additional(struct file_content* pfc,
  ...
  */
  ...
  /* ICC-R2 parameters */
  /* ICC-R2: use flag parser to accept y/n or 0/1 */
  class_read_flag("has_icc", pba->has_icc);
  class_read_double("mu_icc", pba->mu_icc);
